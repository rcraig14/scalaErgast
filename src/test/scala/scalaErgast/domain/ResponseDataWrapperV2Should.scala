...
class ResponseDataWrapperShouldV2 extends AnyFlatSpec with Matchers {
  "ResponseDataWrapper" should "return object with Season List poulated" in {
    ...
    val expected = ResponseDataWrapperV2[SeasonTable](
      ResponseDataV2(
    ...
    circe.jawn.decode[ResponseDataWrapperV2[SeasonTable]](json).map(_ shouldBe expected)
  }
}
